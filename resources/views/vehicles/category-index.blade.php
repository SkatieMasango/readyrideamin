            ...
            <div class="vehicled-body p-6">
                <div class="flex items-center justify-between">
                    <h5 class="text-lg font-semibold text-gray-800">
                        Vehicle
                        <span class="text-sm text-gray-500">Basic list of categories</span>
                    </h5>
                    <div x-data="{ showModal: false }">
                        ...
                        <div x-show="showModal" x-cloak
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-lg create-rider modalContent "
                                ...
                                <form id="form" method="POST" action="{{ route('vehicle-category.store') }}">
                                    @csrf
                                                ...
                                                <div class="bg-white rounded-lg shadow-lg p-6 w-[90%] max-w-md">
                                                    <div class="mb-4 text-center">
                                                        ...
                                                        <p class="text-gray-700 mt-2 text-md">
                                                            You want to permanently delete this vehicle category?
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="flex justify-center gap-3">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('vehicle-category.destroy', $category->id) }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
